    ...
    <div id="upload_movie" className="upload-movie">
      <div className="upload-movie__window">
        ...
        <div
          id="dropzone"
          className={
            "upload-movie__dropzone " + (loadingBar ? "loading" : null)
          }
          {...getRootProps()}
        >
          ...
          <p>
            <span style={{ fontWeight: "700" }}>Agrega un archivo</span> o
            arrastralo y soltalo aquí
          </p>
        </div>
        {}
        <input id="movie_title" type="text" placeholder="título"></input>
        <div className="upload-movie__send" onClick={sendMovie}>
          Subir película
        </div>
        <div className="upload-movie__exit" onClick={closeWindow}>
          Salir
        </div>
      </div>
    </div>
